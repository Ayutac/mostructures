...
class MoStructuresWorldGenProvider  extends FabricDynamicRegistryProvider {
    MoStructuresWorldGenProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
...
//        entries.addAll(registries.getWrapperOrThrow(RegistryKeys.PLACED_FEATURE))
    ...
    @Override
    String getName() {
        return "Mo'Structures' World gen"
    }
}