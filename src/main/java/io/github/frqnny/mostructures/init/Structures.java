...
import io.github.frqnny.mostructures.structure.v1.AirBalloonStructure;
import io.github.frqnny.mostructures.structure.v1.MoaiStructure;
import io.github.frqnny.mostructures.structure.v1.ModStructure;
...
public class Structures {
    ...
    public static final Structure GENERIC = new ModStructure();

    public static final Structure PIRATE_SHIP = new ModStructure(58, false, false);
    public static final Structure LIGHTHOUSE = new ModStructure(65, false, false);
    public static final Structure MOAI = new MoaiStructure(-3);
    public static final Structure AIR_BALLOON = new AirBalloonStructure();
    public static final Structure THE_CASTLE_IN_THE_SKY = new ModStructure(35);
    ...
    public static void init() {
        Registry.register(Registries.STRUCTURE, MoStructures.id("generic"), GENERIC);
